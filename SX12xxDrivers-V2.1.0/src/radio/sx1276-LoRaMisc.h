...
#define RF_CHANNEL_ACTIVITY_DETECTED                0x01
#define RF_CHANNEL_EMPTY                            0x02
...
typedef struct sSX1276LR
{
    ...
    uint8_t RegTestReserved2B[0x30 - 0x2B + 1];       // 0x2B-0x30 
    uint8_t RegDetectOptimize;                      // 0x31    
    uint8_t RegTestReserved32;                      // 0x32   
    uint8_t RegInvertIQ;                            // 0x33 
    uint8_t RegTestReserved34[0x36 - 0x34 + 1];         // 0x34-0x36 
    uint8_t RegDetectionThreshold;                  // 0x37
    uint8_t RegTestReserved38[0x3F - 0x38 + 1];         // 0x38-0x3F
    // I/O settings                
    ...
    // Test
    uint8_t RegTestReserved45[0x4A - 0x45 + 1];         // 0x45-0x4A   
    // Additional settings    
    ...
    // Test    
    uint8_t RegTestReserved4E[0x5A - 0x4E + 1];         // 0x4E-0x5A  
    // Additional settings
    ...
    // Additional settings    
    uint8_t RegTestReserved5E[0x60 - 0x5E + 1];         // 0x5E-0x60
    // Additional settings
    ...
    // Test
    uint8_t RegTestReserved64[0x70 - 0x64 + 1];         // 0x64-0x70
}tSX1276LR;


typedef struct sSX1276LRDevicet{
    tSX1276LR* SX1276LR;
    tLoRaSettings LoRaSettings;
    tRFLRStates rfstate;
}SX1276LRDevice_t;

extern SX1276LRDevice_t sx1278device;
